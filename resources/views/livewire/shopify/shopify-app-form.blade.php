<div>
    ...
    <form wire:submit="save" class="bg-white shadow-md rounded-lg p-6 space-y-4">
        ...
        <fieldset class="border border-gray-200 rounded-lg p-4 space-y-4">
            <legend class="text-sm font-semibold text-gray-700 px-2">API</legend>
            <p class="text-xs text-gray-500 -mt-2">
                Shop başına access token almak için kullanılır. Önce API Auth Endpoint'ten bearer token alınır,
